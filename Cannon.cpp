...
void
IceProxy::Cannon::Collector::injectSubmatrix(::Ice::Int row, ::Ice::Int col, const ::Cannon::Matrix& m, const ::Ice::Context* __ctx)
{
    ...
    while(true)
    {
        ...
        try
        {
            ...
            __del->injectSubmatrix(row, col, m, __ctx, __observer);
            return;
        }
...
::Ice::AsyncResultPtr
IceProxy::Cannon::Collector::begin_injectSubmatrix(::Ice::Int row, ::Ice::Int col, const ::Cannon::Matrix& m, const ::Ice::Context* __ctx, const ::IceInternal::CallbackBasePtr& __del, const ::Ice::LocalObjectPtr& __cookie)
{
...
void
IceDelegateM::Cannon::Collector::injectSubmatrix(::Ice::Int row, ::Ice::Int col, const ::Cannon::Matrix& m, const ::Ice::Context* __context, ::IceInternal::InvocationObserver& __observer)
{
...
void
IceDelegateD::Cannon::Collector::injectSubmatrix(::Ice::Int row, ::Ice::Int col, const ::Cannon::Matrix& m, const ::Ice::Context* __context, ::IceInternal::InvocationObserver&)
{
    class _DirectI : public ::IceInternal::Direct
    {
    public:

        _DirectI(::Ice::Int __p_row, ::Ice::Int __p_col, const ::Cannon::Matrix& __p_m, const ::Ice::Current& __current) : 
        ...
        run(::Ice::Object* object)
        {
            ...
            servant->injectSubmatrix(_m_row, _m_col, _m_m, _current);
    ...
    try
    {
        _DirectI __direct(row, col, m, __current);
        try
        {
...
Cannon::Collector::___injectSubmatrix(::IceInternal::Incoming& __inS, const ::Ice::Current& __current)
{
    ...
    __is->read(m);
    __inS.endReadParams();
    injectSubmatrix(row, col, m, __current);
